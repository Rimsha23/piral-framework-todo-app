...
function withPage(name, value) {
    return (state) => ({
        ...
        registry: {
            ...state.registry,
            pages: (0, helpers_1.withKey)(state.registry.pages, name, value),
        },
    });
}
...
function withoutPage(name) {
    return (state) => ({
        ...
        registry: {
            ...state.registry,
            pages: (0, helpers_1.withoutKey)(state.registry.pages, name),
        },
    });
}
...
function withExtension(name, value) {
    return (state) => ({
        ...
        registry: {
            ...state.registry,
            extensions: (0, helpers_1.withKey)(state.registry.extensions, name, (0, helpers_1.appendItem)(state.registry.extensions[name], value)),
        },
    });
}
...
function withoutExtension(name, reference) {
    return (state) => ({
        ...
        registry: {
            ...state.registry,
            extensions: (0, helpers_1.withKey)(state.registry.extensions, name, (0, helpers_1.excludeOn)(state.registry.extensions[name], (m) => m.reference === reference)),
        },
    });
}
...
function withProvider(provider) {
    ...
    return (state) => ({
        ...state,
        provider: !state.provider ? wrapper : (props) => (0, react_1.createElement)(state.provider, undefined, wrapper(props)),
    });
}
...
function withRoute(path, component) {
    return (state) => ({
        ...state,
        routes: (0, helpers_1.withKey)(state.routes, path, component),
    });
}
