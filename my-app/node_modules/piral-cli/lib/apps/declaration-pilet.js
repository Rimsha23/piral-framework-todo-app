...
exports.declarationPilet = exports.declarationPiletDefaults = void 0;
...
async function declarationPilet(baseDir = process.cwd(), options = {}) {
    ...
    for (const item of allEntries) {
        ...
        const { peerDependencies, peerModules, root, apps, piletPackage, importmap } = await (0, common_1.retrievePiletData)(targetDir);
        ...
        await (0, common_1.createPiletDeclaration)(piletPackage.name, piralInstances, root, item, externals, dest, forceOverwrite, logLevel);
    }
