...
export declare function findPiralInstance(proposedApp: string, rootDir: string, details?: PiralInstanceDetails): Promise<PiralInstancePackageData>;
export declare function findPiralInstances(proposedApps: Array<string>, piletPackage: PiletPackageData, piletDefinition: undefined | PiletDefinition, rootDir: string): Promise<PiralInstancePackageData[]>;
